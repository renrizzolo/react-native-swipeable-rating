...
SwipeableRating.propTypes = {
  ...
  filledIcon: PropTypes.oneOfType([PropTypes.string, PropTypes.function]),
  halfFilledIcon: PropTypes.oneOfType([PropTypes.string, PropTypes.function]),
  emptyIcon: PropTypes.oneOfType([PropTypes.string, PropTypes.function]),
};
